...
print('Load Compare Names')
theseIslands = names.readTheseIslandsFirstNamesFrequency()
theseIslands.info(verbose=True)
theseIslands.to_csv(const.firstNamesCompareName, index=False)
